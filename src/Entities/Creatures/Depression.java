...
public class Depression extends Creature {
	...
	public Depression(Handler handler, float x, float y, String uniqueName) {
		...
		bounds.height = 32;
		//Animations
		animDown = new Animation(200, Assets.depressionDown);
		animLeft = new Animation(200, Assets.depressionLeft);
		animUp = new Animation(200, Assets.depressionUp);
		animRight = new Animation(200, Assets.depressionRight);
	}
	...
	public void interactedWith() {
		textboxHandler = new TextboxHandler(handler, Assets.serif,
				...
				null, 2, Color.WHITE, null, Assets.textboxDepression, null, 50, true, true);
