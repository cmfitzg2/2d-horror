...
public class Teacher extends Creature {
	...
	public Teacher(Handler handler, float x, float y, String uniqueName) {
		super(handler, x, y, Creature.DEFAULT_CREATURE_WIDTH + Creature.DEFAULT_CREATURE_WIDTH / 2, Creature.DEFAULT_CREATURE_HEIGHT + Creature.DEFAULT_CREATURE_HEIGHT / 2, uniqueName);
		bounds.x = 16;
		bounds.y = 32;
		bounds.width = 32;
		bounds.height = 32;
		//Animations
		animDown = new Animation(200, Assets.teacherDown);
		animLeft = new Animation(150, Assets.teacherLeft);
		animUp = new Animation(200, Assets.teacherUp);
		animRight = new Animation(150, Assets.teacherRight);
	}
