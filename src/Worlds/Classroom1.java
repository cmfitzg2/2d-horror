...
public class Classroom1 extends World {
    ...
    protected void addEntities() {
        ...
        entityManager.addEntity(new Chalkboard(handler, 13.0f * Tile.TILEWIDTH, 42 + Tile.TILEHEIGHT, Assets.chalkboard[0].getWidth(), Assets.chalkboard[1].getHeight(), "chalkboard1-classroom1", 0));
