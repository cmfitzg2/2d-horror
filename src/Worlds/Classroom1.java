...
public class Classroom1 extends World {
    ...
    protected void addEntities() {
        ...
        entityManager.addEntity(new StudentDesk(handler, 13.0f * Tile.TILEWIDTH - 147 - Assets.emptyDesk.getWidth(), 580, Assets.emptyDesk.getWidth() * 2, Assets.emptyDesk.getHeight() * 2, "StudentDesk-2", StudentDesk.DEPRESSION));
        ...
        entityManager.addEntity(new StudentDesk(handler, 13.0f * Tile.TILEWIDTH + 147 + Assets.chalkboard[0].getWidth() - Assets.emptyDesk.getWidth(), 580, Assets.emptyDesk.getWidth() * 2, Assets.emptyDesk.getHeight() * 2, "StudentDesk-6", StudentDesk.PLAYER));
    }
